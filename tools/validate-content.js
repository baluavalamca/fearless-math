...
function validateConcept(file) {
  ...
  else if (!["NumberLine","BarModel","ArrayGrid","FractionStrip","AreaModel","PlaceValueBlocks","GeometryCanvas","ClockFace","BarChart","PizzaSlices","Abacus","ObjectRow","NumberTrack","FunctionPlot","Solid3D"].includes(c.visual.component))
    err(`visual.component "${c.visual.component}" is not a built component`);
  const COMP = ["NumberLine","BarModel","ArrayGrid","FractionStrip","AreaModel","PlaceValueBlocks","GeometryCanvas","ClockFace","BarChart","PizzaSlices","Abacus","ObjectRow","NumberTrack","FunctionPlot","Solid3D"];
